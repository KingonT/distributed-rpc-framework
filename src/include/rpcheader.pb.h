...
class RpcHeader final :
 ...
 public:
  ...
  // uint32 argsize = 3;
  void clear_argsize();
  uint32_t argsize() const;
  void set_argsize(uint32_t value);
  private:
  uint32_t _internal_argsize() const;
  void _internal_set_argsize(uint32_t value);
  public:
...
inline uint32_t RpcHeader::_internal_argsize() const {
  return _impl_.argsize_;
}
inline uint32_t RpcHeader::argsize() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.argsize)
  return _internal_argsize();
}
inline void RpcHeader::_internal_set_argsize(uint32_t value) {
  
  _impl_.argsize_ = value;
}
inline void RpcHeader::set_argsize(uint32_t value) {
  _internal_set_argsize(value);
  // @@protoc_insertion_point(field_set:mprpc.RpcHeader.argsize)
}
