...
class ResaultCode;
struct ResaultCodeDefaultTypeInternal;
extern ResaultCodeDefaultTypeInternal _ResaultCode_default_instance_;
}  // namespace fixbug
PROTOBUF_NAMESPACE_OPEN
...
template<> ::fixbug::ResaultCode* Arena::CreateMaybeMessage<::fixbug::ResaultCode>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace fixbug {

// ===================================================================

class ResaultCode final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.ResaultCode) */ {
 public:
  inline ResaultCode() : ResaultCode(nullptr) {}
  ~ResaultCode() override;
  explicit PROTOBUF_CONSTEXPR ResaultCode(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ResaultCode(const ResaultCode& from);
  ResaultCode(ResaultCode&& from) noexcept
    : ResaultCode() {
    *this = ::std::move(from);
  }

  inline ResaultCode& operator=(const ResaultCode& from) {
    CopyFrom(from);
    return *this;
  }
  inline ResaultCode& operator=(ResaultCode&& from) noexcept {
  ...
  static const ResaultCode& default_instance() {
    return *internal_default_instance();
  }
  static inline const ResaultCode* internal_default_instance() {
    return reinterpret_cast<const ResaultCode*>(
               &_ResaultCode_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(ResaultCode& a, ResaultCode& b) {
    a.Swap(&b);
  }
  inline void Swap(ResaultCode* other) {
  ...
  void UnsafeArenaSwap(ResaultCode* other) {
    if (other == this) return;
  ...
  ResaultCode* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ResaultCode>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ResaultCode& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ResaultCode& from) {
    ResaultCode::MergeImpl(*this, from);
  }
  private:
  ...
  void InternalSwap(ResaultCode* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.ResaultCode";
  }
  protected:
  explicit ResaultCode(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(class_scope:fixbug.ResaultCode)
 private:
  class _Internal;
...
class LoginResponse final :
 ...
 public:
  ...
  // .fixbug.ResaultCode result = 1;
  bool has_result() const;
  private:
  bool _internal_has_result() const;
  public:
  void clear_result();
  const ::fixbug::ResaultCode& result() const;
  PROTOBUF_NODISCARD ::fixbug::ResaultCode* release_result();
  ::fixbug::ResaultCode* mutable_result();
  void set_allocated_result(::fixbug::ResaultCode* result);
  private:
  const ::fixbug::ResaultCode& _internal_result() const;
  ::fixbug::ResaultCode* _internal_mutable_result();
  public:
  void unsafe_arena_set_allocated_result(
      ::fixbug::ResaultCode* result);
  ::fixbug::ResaultCode* unsafe_arena_release_result();
...
// int32 errcode = 1;
inline void ResaultCode::clear_errcode() {
  _impl_.errcode_ = 0;
}
inline int32_t ResaultCode::_internal_errcode() const {
  return _impl_.errcode_;
}
inline int32_t ResaultCode::errcode() const {
  // @@protoc_insertion_point(field_get:fixbug.ResaultCode.errcode)
  return _internal_errcode();
}
inline void ResaultCode::_internal_set_errcode(int32_t value) {
  
  _impl_.errcode_ = value;
}
inline void ResaultCode::set_errcode(int32_t value) {
  _internal_set_errcode(value);
  // @@protoc_insertion_point(field_set:fixbug.ResaultCode.errcode)
}

// bytes errmsg = 2;
inline void ResaultCode::clear_errmsg() {
  _impl_.errmsg_.ClearToEmpty();
}
inline const std::string& ResaultCode::errmsg() const {
  // @@protoc_insertion_point(field_get:fixbug.ResaultCode.errmsg)
  return _internal_errmsg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ResaultCode::set_errmsg(ArgT0&& arg0, ArgT... args) {
 
 _impl_.errmsg_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.ResaultCode.errmsg)
}
inline std::string* ResaultCode::mutable_errmsg() {
  std::string* _s = _internal_mutable_errmsg();
  // @@protoc_insertion_point(field_mutable:fixbug.ResaultCode.errmsg)
  return _s;
}
inline const std::string& ResaultCode::_internal_errmsg() const {
  return _impl_.errmsg_.Get();
}
inline void ResaultCode::_internal_set_errmsg(const std::string& value) {
  
  _impl_.errmsg_.Set(value, GetArenaForAllocation());
}
inline std::string* ResaultCode::_internal_mutable_errmsg() {
  
  return _impl_.errmsg_.Mutable(GetArenaForAllocation());
}
inline std::string* ResaultCode::release_errmsg() {
  // @@protoc_insertion_point(field_release:fixbug.ResaultCode.errmsg)
  return _impl_.errmsg_.Release();
}
inline void ResaultCode::set_allocated_errmsg(std::string* errmsg) {
  if (errmsg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.ResaultCode.errmsg)
}
...
inline const ::fixbug::ResaultCode& LoginResponse::_internal_result() const {
  const ::fixbug::ResaultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResaultCode&>(
      ::fixbug::_ResaultCode_default_instance_);
}
inline const ::fixbug::ResaultCode& LoginResponse::result() const {
...
inline ::fixbug::ResaultCode* LoginResponse::release_result() {
  
  ::fixbug::ResaultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
...
inline ::fixbug::ResaultCode* LoginResponse::unsafe_arena_release_result() {
...
inline ::fixbug::ResaultCode* LoginResponse::_internal_mutable_result() {
  
  if (_impl_.result_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::ResaultCode>(GetArenaForAllocation());
    _impl_.result_ = p;
  }
  return _impl_.result_;
}
inline ::fixbug::ResaultCode* LoginResponse::mutable_result() {
  ::fixbug::ResaultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.result)
  return _msg;
}
inline void LoginResponse::set_allocated_result(::fixbug::ResaultCode* result) {
...
inline const ::fixbug::ResaultCode& RegisterResponse::_internal_result() const {
  const ::fixbug::ResaultCode* p = _impl_.result_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResaultCode&>(
      ::fixbug::_ResaultCode_default_instance_);
}
inline const ::fixbug::ResaultCode& RegisterResponse::result() const {
...
inline ::fixbug::ResaultCode* RegisterResponse::release_result() {
...
inline ::fixbug::ResaultCode* RegisterResponse::unsafe_arena_release_result() {
...
inline ::fixbug::ResaultCode* RegisterResponse::_internal_mutable_result() {
...
inline ::fixbug::ResaultCode* RegisterResponse::mutable_result() {
  ::fixbug::ResaultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterResponse.result)
  return _msg;
}
inline void RegisterResponse::set_allocated_result(::fixbug::ResaultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.result_;
  }
