...
extern LonginResponseDefaultTypeInternal _LonginResponse_default_instance_;
class ResultCode;
...
template<> ::fixbug::LonginResponse* Arena::CreateMaybeMessage<::fixbug::LonginResponse>(Arena*);
...
class LonginResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LonginResponse) */ {
 public:
  inline LonginResponse() : LonginResponse(nullptr) {}
  ~LonginResponse() override;
  explicit PROTOBUF_CONSTEXPR LonginResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  LonginResponse(const LonginResponse& from);
  LonginResponse(LonginResponse&& from) noexcept
    : LonginResponse() {
    *this = ::std::move(from);
  }

  inline LonginResponse& operator=(const LonginResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline LonginResponse& operator=(LonginResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const LonginResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const LonginResponse* internal_default_instance() {
    return reinterpret_cast<const LonginResponse*>(
               &_LonginResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(LonginResponse& a, LonginResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(LonginResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(LonginResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  LonginResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<LonginResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const LonginResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const LonginResponse& from) {
    LonginResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(LonginResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.LonginResponse";
  }
  protected:
  explicit LonginResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.LonginResponse)
 private:
  class _Internal;
...
class UserServericeRpc_Stub;

class UserServericeRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline UserServericeRpc() {};
 public:
  virtual ~UserServericeRpc();

  typedef UserServericeRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServericeRpc);
};

class UserServericeRpc_Stub : public UserServericeRpc {
 public:
  UserServericeRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  UserServericeRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~UserServericeRpc_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements UserServericeRpc ------------------------------------------
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServericeRpc_Stub);
};
...
inline int32_t LoginRequest::_internal_pwd() const {
  return _impl_.pwd_;
}
inline int32_t LoginRequest::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.pwd)
  return _internal_pwd();
}
inline void LoginRequest::_internal_set_pwd(int32_t value) {
  
  _impl_.pwd_ = value;
}
inline void LoginRequest::set_pwd(int32_t value) {
...
// .fixbug.ResultCode result = 1;
inline bool LonginResponse::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool LonginResponse::has_result() const {
  return _internal_has_result();
}
inline void LonginResponse::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& LonginResponse::_internal_result() const {
...
inline const ::fixbug::ResultCode& LonginResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.LonginResponse.result)
  return _internal_result();
}
inline void LonginResponse::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LonginResponse.result)
}
inline ::fixbug::ResultCode* LonginResponse::release_result() {
...
inline ::fixbug::ResultCode* LonginResponse::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.LonginResponse.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LonginResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* LonginResponse::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.LonginResponse.result)
  return _msg;
}
inline void LonginResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LonginResponse.result)
}

// bool success = 2;
inline void LonginResponse::clear_success() {
  _impl_.success_ = false;
}
inline bool LonginResponse::_internal_success() const {
  return _impl_.success_;
}
inline bool LonginResponse::success() const {
  // @@protoc_insertion_point(field_get:fixbug.LonginResponse.success)
  return _internal_success();
}
inline void LonginResponse::_internal_set_success(bool value) {
  
  _impl_.success_ = value;
}
inline void LonginResponse::set_success(bool value) {
  _internal_set_success(value);
  // @@protoc_insertion_point(field_set:fixbug.LonginResponse.success)
}
...
inline ::fixbug::User* GetFriendListResponse::mutable_friendlist(int index) {
...
GetFriendListResponse::mutable_friendlist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.friendList)
  return &_impl_.friendlist_;
}
inline const ::fixbug::User& GetFriendListResponse::_internal_friendlist(int index) const {
  return _impl_.friendlist_.Get(index);
}
inline const ::fixbug::User& GetFriendListResponse::friendlist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.friendList)
  return _internal_friendlist(index);
}
inline ::fixbug::User* GetFriendListResponse::_internal_add_friendlist() {
  return _impl_.friendlist_.Add();
}
inline ::fixbug::User* GetFriendListResponse::add_friendlist() {
  ::fixbug::User* _add = _internal_add_friendlist();
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friendList)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponse::friendlist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.friendList)
  return _impl_.friendlist_;
}
